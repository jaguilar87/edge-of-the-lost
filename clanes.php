...
$i=1;
while ($r = mysql_fetch_array($result)){echo "<tr><td><b>$i.</b> <a href=\"clan.php?clan=$r[nombre]\">$r[nombre]</a></td><td><b><center><small>$r[puntos]</small></center></b></td><td><div align=\"right\"><small>$r[fondos]</small></div></td></tr>"; $i++;}
echo '</table>';
