...
Switch ($_GET[id]){
case "": echo "<script> location.href='fabrica.php' </script>"; break;
...
case "nuevo":
	 ...
	 echo "<tr><td><a href=\"fabrica.php?act=construir&veh=deslizador\"><img border=0 src=\"images/arr.gif\"></a>Deslizador</td><td>Vehículo Terrestre</td><td>500M</td><td>200T</td></tr>";
	 echo "<tr><td><a href=\"fabrica.php?act=construir&veh=transporte\"><img border=0 src=\"images/arr.gif\"></a>Transporte Ligero</td><td>Nave Pequeña</td><td>3.000M</td><td>750T</td></tr>";
	 echo "<tr><td><a href=\"fabrica.php?act=construir&veh=crucero\"><img border=0 src=\"images/arr.gif\"></a>Crucero de Batalla</td><td>Nave Grande</td><td>10.000M</td><td>2000T</td></tr>";
	 echo '</table>';
	 }else{echo "No eres el lider del clan";}
	 break;

case "vehiculo":
	 if ($_GET[div]==""){echo "<script> location.href='hangar.php' </script>";}
	 ...
	 echo "<big><center><font color=\"#f0f3bb\">$l[nombre]</font></center></big><br><br>Vehículo fabricado por el <b>clan $n[clan]</b><br> Propiedad del <b>$l[tprop] $l[prop]</b>.<br>Tipo: $l[tipo]<br>Posición: <b>($l[x],$l[y])</b>";
...
default:
	 ...
	 if ($n[finalizado]=="S"){echo "<a href=\"proyecto.php?id=vehiculo&div=$l[nombre]\"><font color=\"#0cff05\">Proyecto Finalizado</a></font>";}    
	 break;
