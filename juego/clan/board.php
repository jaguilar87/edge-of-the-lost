...
echo '<center><big><big>Sala de Reuniones</big></big></center><br><table width="100%" border=1><caption align="top">Tabl&oacute;n de anuncios</caption>';
...
while ($r = mysql_fetch_array($result)) {
    ...
    echo "<tr><td><b><font color=\"#ffff00\">#</b>$r[id]</font><br><b>De</b> <font color=\"$t[txtc]\">$r[poster]</font>, <b>d&iacute;a</b> $r[dia]<br>$r[mess]<br></td></tr>";
}

echo "<tr><td><center>&uacute;ltimos 20 mensajes</center></td></tr></table><br>";
echo "Env&iacute;a un mensaje al clan:<form method=\"post\" action=\"clan/board_send.php\">
