...
echo '<script> location.href="clan/?id=voto"</script>';
...
$i=0;
if ($clv[lider]==$us[nombre]){Echo '|[<a href="clan/?id=gest">Gestionar Clan</a>]</center></small><br>Siendo el lider no puedes ver las votaciones de los otros jugadores';}
...
while ($r = mysql_fetch_array($result)){
	  ...
	  echo "</td>";
	  if ($us[nv_sable]>0 && $_GET[cl]==$us[clan]){echo "<td><center><a onMouseover=\" ddrivetip('Votar a $r[nombre] para lider del clan.', '#808080');\" onMouseout=\"hideddrivetip()\" href=\"clan/?id=voto&us=$r[nombre]\"><img border=0 src=\"images/corona.gif\"></a></center></td>";}
	  echo "</tr>";	  	  
	  $voto=$r[cvoto];
	  $nv[$i]=$voto;
	  if ($voto!=""){$v[$voto]++;}
