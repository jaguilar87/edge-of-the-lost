<?php
    include 'header.php';
    echo '<b>Veh&iacute;culos del Clan:</b>';



    $c="SELECT * FROM `sw_vehiculos` WHERE prop='$cl[nombre]' AND tprop='Clan' ORDER BY nombre ASC";
    $result=mysql_query($c)or die(mysql_error());
    echo '<table width="100%"><tr><td><b>Nombre</b></td><td><b>Posici&oacute;n</b></td><td><b>Da&ntilde;os</b></td></tr>';
