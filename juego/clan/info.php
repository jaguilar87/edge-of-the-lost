...
<?php
                ...
                echo "<b>L&iacute;der:</b> <a href='lista/info.php?us=$lid[nombre]'>$lid[nom]</a><br>";
                echo "<b>Hermandad: </b>";
                ...
                echo "<b>Pot&eacute;ncia:</b> $cli[potencia]W<br>";
...
if ($us[clan]==$cli[nombre]) {
    ?>
				...
				<form action="clan/" Method="GET">
					...
					Cr&eacute;ditos al clan. <input type="submit" value="Donar">
				</form></small>
<?php
