...
if ($_GET[cre]<=0) {
    ...
    if ($us[creditos]<0) {
        ...
        echo "Donados $_GET[cre] Cr&eacute;ditos al Clan!";
        $cl[fondos] += $_GET[cre];
        ...
        mysql_query("INSERT INTO `sw_board_clan` (clan, poster, dia, mess) VALUES ('$cl[nombre]', 'INFORMACION', '$us[dia]', '$us[nombre] ha donado $_GET[cre] Cr&eacute;ditos al Clan!')")or die(mysql_error());
