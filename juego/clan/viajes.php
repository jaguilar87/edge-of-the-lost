...
$pde=sel("sw_plan", "", $de[planeta]);
	  ...
	  if ($ve[tipo]=="VCA" && $pde[nombre]!=$por[nombre]){echo 'Ese tipo de veh�culo no es v�lido para ese viaje.';}else{
...
echo '</select><br><br>Veh�culo: <select name="ve">';
...
echo '</select><br><br>Precio: <input name="pre" type="text" value="200"> Cr�ditos<br><br><input type="submit" value="Crear Ruta"></form>';

echo "<br><br><big><big><center>Gesti�n de Rutas ya existentes</center></big></big>";
