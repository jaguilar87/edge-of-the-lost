<?php
    ...
    if ($cl[lider]==$us[nombre]) {
        ...
        //Sueldo
        echo "<form action=\"clan/\" method=\"GET\"><b>Pago en generador:</b> <input name=\"pago\" align='right' type=\"text\" value=\"$cli[pago]\">Cr&eacute;ditos. <input name=\"id\" type=\"hidden\" value=\"mina\"><input type=\"submit\" value=\"Modificar\"></form>";
        ...
        echo '<br><a href="ciudad/?id=pastilleros"><img border=0 src=images/e.jpg> a&ntilde;adir un proyecto</a>';

        //Rutas
        echo '<br><a href="clan/?id=viajes"><img border=0 src=images/arr.gif> Gestionar Rutas de Viaje</a>';

        //Descripci&oacute;n
        echo "<center>Descripci&oacute;n del clan:<form method='post' action='clan/?id=desc'><textarea style='width:500px' name='dtxt'>$cl[dtxt]</textarea><br><input type=\"submit\" value=\"Modificar\"></form>";
    } else {
