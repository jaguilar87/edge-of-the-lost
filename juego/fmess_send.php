...
if ($enviar) {
   ...
   }else{echo 'El destinatario no existe....'; }
 
}else{
?> 
Envía un mensaje a otro jugador.
<form method="post" action="fmess_send.php">
<b>Emisor:</b><br> <?php echo $nombre; ?>
<br><b>Receptor:</b><br><input type="Text" name="re" Value=<?php echo "\"$_GET[to]\""; ?>">
<br><b>Mensaje:</b><br><textarea style="width:450px" name="me"></textarea>
   <br><input type="Submit" name="enviar" value="send">
</form> 
<br><small><a href="fmess.php">Volver al gestor de mensajes.</a></small>  
<?php 
} //end if 
include 'footer.php'; ?> 
