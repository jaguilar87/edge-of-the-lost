<?php include 'header.php';
	  if ($us[nivel]=="Usuario de la Fuerza"){echo 'A tu nivel aun no puedes atacar...';}else{
	  	 if ($_GET[ob]==""){echo 'Para atacar debes elegir un oponente de tu ciudad:<br>';
			...
			$i=1;
			while ($r = mysql_fetch_array($result)){$u=textcolor($r[nombre]); echo "<tr><td><a href=\"acombate.php?ob=$r[nombre]\"><img border=0 src=\"images/atk.gif\"></a><b>$i.</b> <a href=\"info.php?us=$r[nombre]\"> <font color=\"$u[txtc]\"><small>$r[titulo] $r[nombre]</small></font></a></td><td><b><center><small>$r[puntos]</small></center></b></td><td><div align=\"right\"><small>$r[creditos]</small></div></td><td>$r[clan]</td></tr>"; $i++;}
			echo '</table>';
