...
switch ($_GET[ac]){
   			   ...
   			   echo "Fundando la Ciudad ($_GET[nombre])....";
					   ...
					   $us[creditos]-=500000;
   					   if ($us[creditos]<0){Echo "No tienes creditos suficientes...";}else{
   					   	  if ($us[nv_sable]>2){echo 'Debes ser Maestro o Lord para fundar una ciudad';}else{
	   ...
	   case "clan":
	        ...
	        if ($_POST[nom]!=""){ 
			   ...
			   if ($us[nv_sable]>2){echo '<br>Tramitando papeleo...'; 
			   ...
			   }else{echo '<br><font color="#ee1200">Debes ser Maestro o Lord para fundar un clan</font>';}
