<?php
    ...
    echo "SISTEMA DE ADMINISTRACI&Oacute;N DE SW-EOTLW<br><br>Bienvenido $_SESSION[nombre]. Tu nivel Actual de administrador es <b>$us[admin]</b>. Tus opciones como Admin son:<br>";
