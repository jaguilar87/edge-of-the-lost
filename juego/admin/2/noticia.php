...
if ($_GET[ok]){
   ...
   if ($us[admin]>=$_GET[nv]){
	  ...
	  echo "Noticia a�adida <a href='admin.php?nv=$_GET[nv]&tip=noticia.php'>Incluir Otra</a>.";
	}else{echo "No tienes suficiente nivel";	}
}else{

	  echo '
	  <form action="admin.php" Method="GET">
	  <b><big>A�ADIR NOTICIA</big></b><br>
	  <input name="nv" type="hidden" value="'.$_GET[nv].'">
	  <input name="tip" type="hidden" value="noticia.php">
	  T�tulo: <input name="tipo" type="text" Style="width:600px" value="">
