...
echo '<font color="#ff0000"><center><big><big><blink>¡ATENCION!</blink></big></big><br>Si pulsas el siguiente boton todas las tablas de la partida se borrarán!<br><br><a href="admin.php?nv='.$_GET[nv].'&tip=finpar.php&ok=true"><img src="fin.gif"></a></center>';
