...
case "new":
	 ...
	 echo "<form action='admin.php'><input name='nv' type='hidden' value='$_GET[nv]'><input name='tip' type='hidden' value='voto.php'><input name='ac' type='hidden' value='newok'>Añadir:";
	 ...
	 echo '<br>Si necesita mas numero de respuestas contacte con el administrador Zeros Mettallium. Recuerda que al añadir una nueva votacion la votacion en la anterior desaparecerá.';
	 echo '<br><input type="submit" value="Crear Nueva Votación"></form>';  
break;
...
break;
	 ...
	 echo "<form action='admin.php'><input name='nv' type='hidden' value='$_GET[nv]'><input name='tip' type='hidden' value='voto.php'><input name='ac' type='hidden' value='mod'>Modificar Votación: REF = <input name='ref' style='width:50px' type='text'> <input type='submit' value='Mod.'></form>";
	 echo '<font color="#808080"><b><br><br><em>Aclaración:<br>Ref se refiere al numero de la votacion, todas las entradas con el mismo ref pertenecen a la misma votacion; siendo tipo=0 la pregunta y el resto las posibles respuestas.</em></b></font>';
