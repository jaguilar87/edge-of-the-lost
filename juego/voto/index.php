...
$result = mysql_query($c)or die(mysql_error());
while ($voters = mysql_fetch_array($result)){$i++;}

if ($i==0){
	  echo "<tr><td>Nadie ha Votado todav�a</td><td></td></tr>";
}else{
...
echo "</table>";
}else{ echo "No tienes suficiente nivel para votar, debes ser como m�nimo CABALLERO/GUERRERO";}
