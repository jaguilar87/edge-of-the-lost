...
if ($us[evoto]==null) {
    ...
    echo "Votado! Redireccionando...<META HTTP-EQUIV=\"Refresh\" CONTENT=\"2;URL=voto/\">";
} else {
    echo "Ya has votado anteriormente! No puedes volver a votar. <META HTTP-EQUIV=\"Refresh\" CONTENT=\"2;URL=voto/\">";
}
