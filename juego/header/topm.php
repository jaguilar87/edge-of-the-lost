...
menu[0][0] = new Menu(false, '', 100, 125, 20, '#c0c0c0', '#ffffff', 'itemBorder', 'itemText');

// The 'length' of each of these items is 40, and there is spacing of 20 to the next item.
// Most of the links are set to '#' hashes, make sure you change them to actual files.

// Distrito SUB-menu
menu[0][1] = new Item('CIUDAD >>', 'idistritos.php', '', 80, 0, 0);
...
menu[1][1] = new Item('Ayuntamiento', 'idistritos.php?def=iagobierno.php', '', defLength, 0, 0);
menu[1][2] = new Item('Censo', 'idistritos.php?def=iacenso.php', '', defLength, 0, 0);
menu[1][3] = new Item('Parlamento', 'idistritos.php?def=iaparlamento.php', '', defLength, 0, 0);
menu[1][4] = new Item('Ley', 'idistritos.php?def=ialey.php', '', defLength, 0, 0);

//Distrito Residencial
menu[2] = new Array();
menu[2][0] = new Menu(true, '', 0, 22, 100, defOver, defBack, 'itemBorder', 'itemText');
menu[2][1] = new Item('Hospital', 'idistritos.php?def=irhospital.php', '', defLength, 0, 0);
menu[2][2] = new Item('Burdeles', 'idistritos.php?def=irburdel.php', '', defLength, 0, 0);
menu[2][3] = new Item('Academia', 'entre.php', '', defLength, 0, 0);
...
menu[3][1] = new Item('Trabajo', 'trabajo.php', '', defLength, 0, 0);
menu[3][2] = new Item('Crimen', 'crimen.php', '', defLength, 0, 0);
menu[3][3] = new Item('Bar', 'idistritos.php?def=icbar.php', '', defLength, 0, 0);
...
menu[4][1] = new Item('Mina', 'idistritos.php?def=iimina.php', '', defLength, 0, 0);
menu[4][2] = new Item('Generador', 'idistritos.php?def=iigenerador.php', '', defLength, 0, 0);
menu[4][3] = new Item('Armeria', 'idistritos.php?def=iiarmeria.php', '', defLength, 0, 0);

//Puerto Estelar
menu[5] = new Array();
menu[5][0] = new Menu(true, '', 0, 22, 100, defOver, defBack, 'itemBorder', 'itemText');
menu[5][1] = new Item('Viaje', 'ipviaje.php', '', defLength, 0, 0);
menu[5][2] = new Item('Hangar', 'iphangar.php', '', defLength, 0, 0);
menu[5][3] = new Item('Astilleros', 'idistritos.php?def=ipastilleros.php', '', defLength, 0, 0);
//menu[5][4] = new Item('Sabotear', 'nod.php', '', defLength, 0, 0);

//Afueras
menu[6] = new Array();
menu[6][0] = new Menu(true, '', 0, 22, 100, defOver, defBack, 'itemBorder', 'itemText');
menu[6][1] = new Item('Cazar', 'iacaza.php', '', defLength, 0, 0);
