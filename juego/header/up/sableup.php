   ...
   break;
	 ...
	 case "1":
	 		if ($us[lado]>=0){
				 $titulo="Padawan";
				 $nivel="Padawan Jedi";
				 $nvdesc="PADAWAN JEDI: Tu camino en la fuerza ha comenzado, est�s en el lado de la luz, pero nada es irreversible, puedes cambiar de bando en cualquier momento, as� que cuida tus actos. Ascender�s de nivel cuando derrotes a 15 enemigos.";
			}else{
				 $titulo="Aprendiz";
				 $nivel="Aprendiz Sith";
				 $nvdesc="APRENDIZ SITH: Tu camino en la fuerza ha comenzado, est�s en el lado Oscuro, pero nada es irreversible, puedes cambiar de bando en cualquier momento, as� que cuida tus actos. Ascender�s de nivel cuando derrotes a 15 enemigos.";
			}
	 break;
