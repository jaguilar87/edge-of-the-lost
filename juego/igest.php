					   ...
					   <td>
				  	   ...
				  	   <td>
					   	   <spam Title=\"Clausurar\">
						   		 <a href=\"igest.php?ac=des&ob=$nombre&ciudad=$cic[nombre]\">
								 	<img border=0 src=\"images/x.gif\">
								 </a>
						   </spam>
						   <spam title=\"Construir\">
						   		 <a href=\"igest.php?ac=co&ob=$nombre&ciudad=$cic[nombre]\">
   ...
   if ($cic[rey]==$us[nombre]){  	
	  ...
	  switch ($_GET[ac]){
		...
		case "arr":
				...
				echo 'Ciudad arrasada... <script> location.href="idistritos.php" </script>';
		...
		case "tor":
			 switch($_GET[tip]){
			 	case "sam": $cost=500000;
				case "blaster": $cost=550000;
				case "damascus": $cost=600000;
				case "generador": $cost=250000;
			 }
		...
		break;
			 ...
			 if ($cic[central]<5){echo "<br><a href='igest.php?ac=cen'>MEJORAR CENTRAL $man C</a>";}
			 ...
			 echo "</center></td></tr></table><center><br><table bgcolor='#808080'><tr><td><form action=\"igest.php\" METHOD=\"GET\"> <input name=\"ac\" type=\"hidden\" value=\"prec\">Modificar precios de <select name=\"costt\">
			...
			if ($cic[ley]=="S"){
				  ...
				  echo "</small><i>Torres:</i><br><small>
				  	 &nbsp;&nbsp;&nbsp;<b>$cic[sam]</b> Torres SAM <a href=\"igest.php?ac=tor&tip=sam\" onMouseover=\" ddrivetip('Las Torres SAM dañan a los Vehiculos atacantes<br><b>Precio: 500.000C </b>', '#808080');\" onMouseout=\"hideddrivetip()\"><img  border=0 src=\"images/e.jpg\"></a><br>
					   &nbsp;&nbsp;&nbsp;<b>$cic[blaster]</b> Torres Blaster <a href=\"igest.php?ac=tor&tip=blaster\" onMouseover=\" ddrivetip('Las Torres Blaster disparan contra el escudo de los atacantes pero sobretodo contra los PJ atacantes<br><b>550.000 C</b>', '#808080');\" onMouseout=\"hideddrivetip()\"><img  border=0 src=\"images/e.jpg\"></a><br>
					   &nbsp;&nbsp;&nbsp;<b>$cic[damascus]</b> Torres Damascus <a href=\"igest.php?ac=tor&tip=damascus\" onMouseover=\" ddrivetip('Las Torres Damascus produce una vibración de onda corta que es capaz de dañar los escudos de los Atacantes<br><b> 600.000 C</b>', '#808080');\" onMouseout=\"hideddrivetip()\"><img  border=0 src=\"images/e.jpg\"></a><br>
					   &nbsp;&nbsp;&nbsp;<b>$cic[generador]</b> Generador de Escudo <a href=\"igest.php?ac=tor&tip=generador\" onMouseover=\" ddrivetip('Las Cada generador produce 500u de Escudo<br> <b>250.000 C</b>', '#808080');\" onMouseout=\"hideddrivetip()\"><img  border=0 src=\"images/e.jpg\"></a><br>
					   ";
			...
			echo "<br><hr><br><form action=\"clanact.php?act=darciudad&ciudad=$cic[nombre]\" Method=\"POST\">Dar control de la Ciudad a: <select name=\"nombre\">";
