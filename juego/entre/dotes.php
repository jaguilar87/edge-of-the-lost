<?php
if ($us[nv_sable]==0){
   echo "<center><a onMouseover=\" ddrivetip('<center><big>�CIUDADO!</font></big><br>Si asciendes de nivel, los otros jugadores podr�n atacarte.</center>', '#808080');\" onMouseout=\"hideddrivetip()\" href=\"ascender.php\">Entrar en una Academia</a> Coste: 10.000 Cr�ditos</center>";
}else{
