   ...
   if ($cic[nombre]!=$ci[nombre] || $cl[lider]!=$us[nombre] || $cic[clan]==$us[clan] || $cic[atacada]!="N" || $us[clan]==""){
		 ...
		 if ($za[estado]=="Aliado"){
		 	echo "No puedes atacar la ciudad de un clan aliado!";
  		 	...
  		 	include 'ataque/atc.php';
				include 'ataque/ciudad_res.php'; 
   		 }
   }

}else{
	  echo "<big><big><b>Planeando ataque contra la ciudad $cic[nombre]</b></big></big><br><br>
	  Si tu clan ataca la ciudad de <b>$cic[nombre]</b> gastará potencia, como más dure la defensa de la ciudad, más potencia se gastará.<br>Si tu clan se queda sin potencia a medio combate hay muchas probabilidades de perder el combate.<br><a href='ataque/?id=ciudad&ok=true'>Atacar!</a>"; 
}
