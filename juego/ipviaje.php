...
while ($s = mysql_fetch_array($result2)){$mi=textcolor($s[rey]); echo "<tr><td><a href=\"ipviajok.php?pl=$r[nombre]&ci=$s[nombre]\"><img border=0 src=\"images/arr.gif\"></a> <a href=\"idistritos.php?ciudad=$s[nombre]\">$s[nombre]</a></td><td><a href=\"csede.php?clan=$s[clan]\"><font color=\"#ffffff\">$s[clan]</font></a></td><td><a href=\"info.php?us=$mi[nombre]\"><font color=\"$mi[txtc]\">$mi[nombre]</font></a></td></tr>";}
?>
</table>
<br><br><em>Elegir otro planeta de destino:</em>
<?php include 'mapa.php'; mapear("ipviaje.php"); ?>
