...
while ($s = mysql_fetch_array($result2)){$mi=textcolor($s[rey]); echo "<tr><td><a href=\"ciudad/?ciudad=$s[nombre]\">$s[nombre]</a></td><td><a href=\"csede.php?clan=$s[clan]\"><font color=\"#ffffff\">$s[clan]</font></a></td><td><a href=\"info.php?us=$mi[nombre]\"><font color=\"$mi[txtc]\">$mi[nombre]</font></a></td></tr>";}
