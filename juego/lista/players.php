...
echo "Nombre<a href=\"lista/players.php?by=nombre&ord=DESC&nv=$_GET[nv]&ko=$_GET[ko]\"><img border=0 src=\"images/a_down.gif\"></a><a href=\"lista/players.php?by=nombre&ord=ASC&nv=$_GET[nv]&ko=$_GET[ko]\"><img  border=0 src=\"images/a_up.gif\"></a></b></td><td><b><center><small>M�rito<a href=\"lista/players.php?by=merito&ord=DESC&nv=$_GET[nv]&ko=$_GET[ko]\"><img border=0 src=\"images/a_down.gif\"></a><a href=\"lista/players.php?by=merito&ord=ASC&nv=$_GET[nv]&ko=$_GET[ko]\"><img  border=0 src=\"images/a_up.gif\"></a></small></center></b></td><td><b><div align=\"right\"><small>Cr�ditos<a href=\"lista/players.php?by=creditos&ord=DESC&nv=$_GET[nv]&ko=$_GET[ko]\"><img  border=0 src=\"images/a_down.gif\"></a><a href=\"lista/players.php?by=creditos&ord=ASC&nv=$_GET[nv]&ko=$_GET[ko]\"><img  border=0 src=\"images/a_up.gif\"></a></small></div></b></td></tr>";
...
$i=1;
while ($r = mysql_fetch_array($result)){$u=textcolor($r[nombre]); echo "<tr><td><b>$i.</b> <a href=\"lista/info.php?us=$r[nombre]\"><font color=\"$u[txtc]\">$r[titulo] $r[prefix] $r[nombre]</font></a>"; if($r[hp]<=0){echo ' <sup><b><small><font color="#ffff80">KO</font></small></b></sup>';}  echo "</td><td><b><center><small>$r[merito]</small></center></b></td><td><div align=\"right\"><small>$r[creditos]</small></div> </td></tr>"; $i++;}
echo '</table>';
