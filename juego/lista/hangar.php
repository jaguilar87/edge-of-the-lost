...
echo "<tr bgcolor='#808080'><td><i>Veh&iacute;culos</i> </td><td><b>Propietario</b></td></tr>";
...
echo "<tr bgcolor='#808080'><td><i>Tus Veh&iacute;culos:</i> </td><td></td></tr>";
...
while ($p = mysql_fetch_array($result)) {
    ...
    if ($us[nombre]==$cl[lider]) {
        echo " <a onMouseover=\" ddrivetip('Comprar para el clan', '#808080');\" onMouseout=\"hideddrivetip()\" href=\"ciudad/?id=pcomprar&veh=$p[nombre]&ac=clan\"><img border=0 src=\"images/new.gif\"></a>";
    }
    echo "</td></tr>";
}
echo '</table>';
