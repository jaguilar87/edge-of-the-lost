...
if ($cle[nombre]!=""){
   ...
   echo "$cl[nombre] Vs $cle[nombre]<br>$log<br>$ganador<br>$gana";
	 ...
	 mysql_query("INSERT INTO `sw_board_clan` (poster, mess, clan, dia) VALUES ('INFORMACION','La ciudad <b>$cic[nombre]</b> ha sido atacada por el clan <b>$cl[nombre]</b> <a href=\"alista.php#clan\">Ver Combate</a>', '$cl[nombre]','$us[dia]')")or die(mysql_error());
	 mysql_query("INSERT INTO `sw_board_clan` (poster, mess, clan, dia) VALUES ('INFORMACION','La ciudad <b>$cic[nombre]</b> ha sido atacada por el clan <b>$cl[nombre]</b> <a href=\"alista.php#clan\">Ver Combate</a>', '$cle[nombre]','$us[dia]')")or die(mysql_error());
