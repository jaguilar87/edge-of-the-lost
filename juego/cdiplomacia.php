...
echo '<br><hr><br><b>Aliados del clan:</b><br>';
   ...
   echo "<br>- El clan <a href=\"csede.php?clan=$r[origen]\">$r[origen]</a> considera <a href=\"csede.php?clan=$r[origen]\">$r[destino]</a> su $r[estado].";
   if ($us[nombre]==$cl[lider] && $r[origen]==$us[clan]){echo "<a href=\"cdiplomacia.php?ac=borrar&id=$r[id]\"><span title=\"borrar\"><img border=0 src=\"images/x.gif\"></a>";} 
...
if ($us[nombre]==$cl[lider]){
echo '<br><hr><br><form action="cdiplomacia.php" METHOD="GET">Añadir <select name="clan">'; 
