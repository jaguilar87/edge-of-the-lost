...
if ($_GET[all]){$c="SELECT * FROM `sw_board_clan` WHERE clan='$cli[nombre]' ORDER BY id DESC";}else{$c="SELECT * FROM `sw_board_clan` WHERE clan='$cli[nombre]' ORDER BY id DESC LIMIT 0,20";}
$result=mysql_query($c)or die(mysql_error());
...
echo '<br><br><a href="cboard.php?all=true">Ver Todos los mensajes antiguos</a>';
