		   ...
		   if ($us[cmess]=="S" && $us[clan]!=""){echo "<a href=\"clan/?id=board\"><span title=\"Mensaje nueno en el Tabl�n del Clan!\"><blink><img border=0 src=\"images/msg.gif\"></blink></span></a> ";}
		   if ($us[mmess]=="S"){ echo "<a href=\"mess/\"><span title=\"Mensaje Nuevo!\"><blink><img border=0 src=\"images/msg.gif\"></blink></span></a> ";}
		   if ($us[attmess]=="S"){echo "<a href=\"combate/lista.php\"><span title=\"Has sido atacado recientemente!\"><blink><img border=0 src=\"images/atk.gif\"></blink></span></a> ";}
		   ?>
...
<?php } ?>		 
	   ...
	   <tr>
	   	   <td width="100%" onMouseover="LmOver(this, '#c0c0c0')" onMouseout="LmOut(this, '#FFFFFF')" onMouseDown="LmDown(this, '#c0c0c0')" bgcolor="#FFFFFF">
		   	   <center><A HREF="estadisticas/" Class="navlink">Estad�sticas</a></center>
		   </td>
	   </tr>	

   	   <tr>
	   	   <td background="images/bg2.gif">
		   	   <center>Comunicaci�n</b></center>
		   </td>
	   <tr>
	   	   <td width="100%" onMouseover="LmOver(this, '#c0c0c0')" onMouseout="LmOut(this, '#FFFFFF')" onMouseDown="LmDown(this, '#c0c0c0')" bgcolor="#FFFFFF">
	   ...
	   <tr>
	   	   <td>
		   <?php
		   echo "<small><center><br><b><u>Informaci�n</u><br>Hp:</b> $us[hp]/$us[maxhp]<br><b>Lado:</b> $us[lado]<br><b>Energ�a:</b> $us[turnos] <br><small><b>Cr�ditos:</b> $us[creditos]</small><br><br><b>Clan:</b> <br>$us[clan]<br><b>Ciudad:</b> <br>$us[ciudad]<br><br><b>D�a:</b> $fe[val]<br><b>Hora:</b> $ach<blink>:</blink>$acm</center></small>";
