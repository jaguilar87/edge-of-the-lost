...
echo "Mostrando los últimos 20 Ataques:<br>";
	  ...
	  echo "<b>$a[id]-</b> <a href=\"alista.php?at=$a[id]\">$a[atacante] Vs $a[defensor] ocurrido el dia $a[dia]</a><br>";
      }
...
if ($us[clan]!=""){
	  ...
	  $result=mysql_query($c)or die(mysql_error());
	  while ($a = mysql_fetch_array($result)){
	  echo "<b>$a[id]-</b> <a href=\"alista.php?at=$a[id]\">Ataque contra $a[defensor] ocurrido el dia $a[dia]</a><br>";
      }
}	  
