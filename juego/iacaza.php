...
if ($luk>0){$us[creditos]+=$gan; $us[puntos]+=$dife; echo "Has cazado un <b>$_POST[tr]</b>! Su caza te ha reportado<b> $gan Créditos</b>";}else{echo "El $_POST[tr] salvaje se te resistió y escapó"; $us[estres]+=3;}
