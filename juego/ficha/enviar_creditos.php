    ...
    if ($_GET[cr]<=0) {
        ...
        if ($us[creditos]<$_GET[cr]) {
            ...
            if ($usto[crecived]>10000) {
                echo "$usto[nombre] ya ha recibido el limite de cr&eacute;ditos por hoy";
            } else {
                ...
                mysql_query("INSERT INTO `sw_log` (user, log, dia, ref, tipo) VALUES ('$usto[nombre]', '$us[nombre] te ha enviado $_GET[cr] Cr&eacute;ditos.', '$us[dia]', '$us[nombre]', '3')")or die(mysql_error());
                ...
                echo "Enviados $_GET[cr] Cr&eacute;ditos a $_GET[to]! (10% de Impuesto)";
            }
        }
    }
} else {
    echo 'No tienes suficiente nivel para enviar dinero.';
}
