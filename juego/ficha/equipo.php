...
<tr>
       ...
       <td bgcolor="#737373" width=300><center><b>Descripci�n</b></center></td>
</tr>
<tr>	   
       <td  VALIGN="TOP">
	   <?php 
...
<?php
			if ($us[nv_sable]==0){
				...
				echo  "<b>Sable l�ser de aprendizaje:</b> Uno de los examenes que has de pasar para entrar en la academia es fabricarte tu poprio sable laser con el cual empezar a luchar.";
			}elseif($us[nv_sable]==2){
				echo  "<b>Sable l�ser:</b> A medida que avanzas en tu aprendizaje vas viendo la necesidad de personalizar tu sable a tu gusto, puediendo ahora elegir otro color.";				
			}elseif($us[nv_sable]>2 AND $us[estilo_sable]=='+'){
				echo  "<b>Sable l�ser largo:</b> Con un sable l�ser largo eres capaz de luchar manteniendo las distancias y de esta manera tener m�s posibilidades de da�ar a tu enemigo y de hacerlo con m�s fuerza. Los luchadores armados con un sable largo son capaces de lanzar ataques poderosos conocidos como: EXTERMINIOS que pueden llegar a hacer el doble de da�o que un ataque normal.";
			}elseif($us[nv_sable]>2 AND $us[estilo_sable]=='11'){
				echo  "<b>Dos sables l�ser:</b> El dominio y la destreza de los sables se multiplican al empu�ar dos sables, con ellos el luchador es capaz de lanzar dos ataques consecutivos, aunque un poco m�s d�biles de lo normal.";				
			}elseif($us[nv_sable]>2 AND $us[estilo_sable]=='2'){
				echo  "<b>Sable l�ser doble:</b> Los luchadores armados con un sable l�ser doble pueden mantener a su enemigo alejado lanzando ataques indiscriminadamente, es por eso que cada vez que da�a el poseedor del sable doble puede tener unos momentos de descanso en los que recuperar su vida mediante la vitalizaci�n.";
			}
?>	   
		</td>
</tr>
...
<tr>
		 ...
		 <?php
	   					...
	   					While ($p=mysql_fetch_array($sqla)){
	   								echo "- $p[objeto] <a onMouseover=\" ddrivetip('Vender la Pieza por Cr�ditos al Mercado.', '#808080');\" onMouseout=\"hideddrivetip()\" href='ciudad/?id=acazav&oid=$p[id]'><img src='images/arr.gif' border=0 alt='Vender pieza al Mercado'></a><br>";
							}
	   ?>				 		</td>
