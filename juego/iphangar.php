...
echo "<tr bgcolor='#808080'><td><i>Vehículos del Clan:</i> </td><td></td></tr>";
	 ...
	 while ($p = mysql_fetch_array($result)){
	 	   echo "<tr>
		   			 <td>
					 	 <a href=\"ipproyecto.php?id=vehiculo&div=$p[nombre]\">
						 	$p[nombre]
						 </a>
					 </td>
					 <td>
...
echo "<tr bgcolor='#808080'><td><i>Tus Vehículos:</i> </td><td></td></tr>";
	 ...
	 while ($p = mysql_fetch_array($result)){
	 	   echo "<tr>
					 ...
					 <td>
					 	 $p[ciudad] 
						 <a onMouseover=\" ddrivetip('Poner a la venta', '#808080');\" onMouseout=\"hideddrivetip()\"  href=\"clanact.php?act=vender&vehiculo=$p[nombre]\"><img border=0 src=\"images/arr.gif\">
						 	<small>Vender</small>
						 </a>
					 </td>
				 </tr>";
...
echo "<tr bgcolor='#808080'><td><i>Vehículos en la ciudad:</i></td><td><b>Propietario</b></td></tr>";
	 ...
	 while ($p = mysql_fetch_array($result)){
	 	   echo "<tr><td><a href=\"ipproyecto.php?id=vehiculo&div=$p[nombre]\">$p[nombre]</a></td><td><small>$p[tprop] $p[prop]</small></td></tr>";
		} 
echo '</table>';
