...
if ($ci[fabrica]=="S" && $us[nombre]==$ci[rey]) {
    if ($_GET[ok]) {
        ...
        if ($_GET[nom]==$vl[nombre] || $_GET[tip]=="") {
            echo "Ese nombre ya existe o no ha seleccionado el tipo de Veh&iacute;culo. ";
        } else {
            switch ($_GET[tip]) {
            ...
            if ($cl[potencia]<0 || $cl[mineral]<0) {
                ...
                if ($_GET[tip]=="Lanzadera" || $_GET[tip]=="Crucero") {
                    $espacio="S";
                } else {
                    $espacio="N";
                }
                ...
                echo "<table background='images/bg3.jpg'  width='100%' height='100%'>
						  <tr>
						      <td><big><big><b>Astilleros de $ci[nombre]</b></big></big><br><br>Veh&iacute;culo Construido</td></tr></table>";
            }
        }
    } else {
        echo "<table background='images/bg3.jpg'  width='100%' height='100%'>
...
<tr>
    <td>    <form action="ciudad/" method="GET">
					   	   ...
					   	   Nombre del Veh&iacute;culo: <br>&nbsp;&nbsp;<input name="nom" type="text" value="">
					   	   <br><br>Tipo veh&iacute;culo: <br>&nbsp;&nbsp;<input name="tip" type="radio" value="VCA">VCA <br>&nbsp;&nbsp;<input name="tip" type="radio" value="Lanzadera">Lanzadera <br>&nbsp;&nbsp;<input name="tip" type="radio" value="Crucero">Crucero
...
';
        echo '<small><b><b>Veh&iacute;culos:</b></b></small><br><small><table width="100%" ><tr bgcolor="#808080"><td><small><b>Nombre</b></small></td><td><small><b>Tipo</b></small></td><td><small>Minerales</small></td><td><small>Potencia</small></td></tr><tr><td><small>VCA</small></td><td><small>Veh&iacute;culo Terrestre</small></td><td><small>500M</small></td><td><small>200W</small></td></tr><tr><td><small>Lanzadera</small></td><td><small>Transporte Ligero</small></td><td><small>3.000M</small></td><td><small>750W</small></td></tr><tr><td><small>Crucero</small></td><td><small>Gan nave de combate espacial</small></td><td><small>10.000M</small></td><td><small>2000W</small></td></tr></table></small></td>
</tr>
</table>';
    }
} else {
