...
if ($ci[fabrica]=="S" && $us[nombre]==$ci[rey]){
   if ($_GET[ok]){
				  ...
				  if ($_GET[nom]==$vl[nombre] || $_GET[tip]==""){
				  	 echo "Ese nombre ya existe o no ha seleccionado el tipo de Veh�culo. ";
				  }else{
						 ...
						 mysql_query("INSERT INTO `sw_vehiculos` (nombre, tipo, ciudad, prop, tprop, espacio, arma, mineral, potencia, fabricante, dia) VALUES ('$_GET[nom]', '$_GET[tip]', '$ci[nombre]', '$ci[clan]', 'Clan', '$espacio', '$arma', '$min', '$tur', '$cl[nombre]', '$us[dia]')")or die(mysql_error());
						  ...
						  <tr>					  
						      <td><big><big><b>Astilleros de $ci[nombre]</b></big></big><br><br>Veh�culo Construido</td></tr></table>";   
...
<tr>
    <td>    <form action="ciudad/" method="GET">
					   	   ...
					   	   Nombre del Veh�culo: <br>&nbsp;&nbsp;<input name="nom" type="text" value="">
					   	   <br><br>Tipo veh�culo: <br>&nbsp;&nbsp;<input name="tip" type="radio" value="VCA">VCA <br>&nbsp;&nbsp;<input name="tip" type="radio" value="Lanzadera">Lanzadera <br>&nbsp;&nbsp;<input name="tip" type="radio" value="Crucero">Crucero
...
';
		 echo '<small><b><b>Veh�culos:</b></b></small><br><small><table width="100%" ><tr bgcolor="#808080"><td><small><b>Nombre</b></small></td><td><small><b>Tipo</b></small></td><td><small>Minerales</small></td><td><small>Potencia</small></td></tr><tr><td><small>VCA</small></td><td><small>Veh�culo Terrestre</small></td><td><small>500M</small></td><td><small>200W</small></td></tr><tr><td><small>Lanzadera</small></td><td><small>Transporte Ligero</small></td><td><small>3.000M</small></td><td><small>750W</small></td></tr><tr><td><small>Crucero</small></td><td><small>Gan nave de combate espacial</small></td><td><small>10.000M</small></td><td><small>2000W</small></td></tr></table></small></td>
</tr>
</table>';
