...
if ($_GET[ciudad]==""){$_GET[ciudad]=$ci[nombre];}
   ...
   $u=textcolor($cic[rey]);
   echo "<center><big>Gesti�n de $cic[nombre]</big></center><hr>";
   ...
   if ($cic[rey]==$us[nombre]){  	
	  ...
	  switch ($_GET[ac]){
		...
		case "prec":
				   ...
				   echo "Valor no v�lido, debe ir de 1 a 30";
				}
		break;
		...
		break;
			 ...
			 switch ($cic[central]){
			  	case "1": $cen="Central Solar (100W/Dia)"; break;
					...
					case "5": $cen="Central Fusi�n Nuclear (1000W/Dia)"; break;
			 }
			 
			 $ma= $cic[central]*10000;
			 $man= $ma+10000;
			 echo "<center><b>$cen</b><br>Mantenimiento: $ma Cr�ditos";
			...
			echo "<br><small>Hospital: $cic[costec] C/PV | Bar: $cic[copas]/Estr�s | Impuestos: $cic[impuesto] % | Presupuesto Ley: $cic[leypre] Puntos</small></td></tr></table></center>";
			...
			if ($cic[ley]=="S"){
				  ...
				  echo "</small><i>Torres:</i><br><small>
				  	   &nbsp;&nbsp;&nbsp;<b>$cic[sam]</b> Torres SAM <a href=\"ciudad/?id=gest&ac=tor&tip=sam\" onMouseover=\" ddrivetip('Las Torres SAM da�an a los Vehiculos atacantes<br><b>Precio: 500.000C </b>', '#808080');\" onMouseout=\"hideddrivetip()\"><img  border=0 src=\"images/e.jpg\"></a><br>
				  ...
				  while ($r=mysql_fetch_array($sql)){$c++;}
 				  ...
 				  echo "</small><i>Veh�culos:</i><br><small>
