...
if ($_GET[ciudad]=="") {
   ...
   $u=textcolor($cic[rey]);
   echo "<center><big>Gesti&oacute;n de $cic[nombre]</big></center><hr>";
   ...
   if ($cic[rey]==$us[nombre]) {
       switch ($_GET[ac]) {
        ...
        case "prec":
                if ($_GET[costc]<=30 && $_GET[costc]>0) {
                    ...
                    echo "Valor no v&aacute;lido, debe ir de 1 a 30";
                }
        break;
        ...
        break;
        case "ren":
            $ciE = sel("sw_city", "", $_GET['new']);
            if ($ciE[nombre]!="") {
                echo "Ya existe una ciudad con ese nombre";
            } else {
                ...
                mysql_query("UPDATE sw_viaje SET destino='$_GET[new]' WHERE destino='$cic[nombre]'")or die(mysql_error());
                mysql_query("UPDATE sw_viaje SET origen='$_GET[new]' WHERE origen='$cic[nombre]'")or die(mysql_error());
       ...
       switch ($cic[central]) {
                case "1": $cen="Central Solar (100W/Dia)"; break;
                    ...
                    case "5": $cen="Central Fusi&oacute;n Nuclear (1000W/Dia)"; break;
             }

       $ma= $cic[central]*10000;
       $man= $ma+10000;
       echo "<center><b>$cen</b><br>Mantenimiento: $ma Cr&eacute;ditos";
       if ($cic[central]<5) {
           echo "<br><a href='ciudad/?id=gest&ac=cen'>MEJORAR CENTRAL $man C</a>";
       }
       ...
       echo "<br><small>Hospital: $cic[costec] C/PV | Bar: $cic[copas]/Estr&eacute;s | Impuestos: $cic[impuesto] % | Presupuesto Ley: $cic[leypre] Puntos</small></td></tr></table></center>";
       ...
       if ($cic[ley]=="S") {
           ...
           echo "</small><i>Torres:</i><br><small>
				  	   &nbsp;&nbsp;&nbsp;<b>$cic[sam]</b> Torres SAM <a href=\"ciudad/?id=gest&ac=tor&tip=sam\" onMouseover=\" ddrivetip('Las Torres SAM da&ntilde;an a los Vehiculos atacantes<br><b>Precio: 500.000C </b>', '#808080');\" onMouseout=\"hideddrivetip()\"><img  border=0 src=\"images/e.jpg\"></a><br>
           ...
           echo "</small><i>Veh&iacute;culos:</i><br><small>
       ...
       echo "<br><form method=\"GET\"><input type='hidden' name='ac' value='ren'><input type='text' name='new' value='$cic[nombre]' style='width:400px'> <input style='width:98px' type='submit' value='Cambiar Nombre'/> </form>";
   } else {
       echo 'No eres el regente de la ciudad, no puedes gestionarla...';
   }
