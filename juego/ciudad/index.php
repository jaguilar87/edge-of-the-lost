...
if ($ci[nombre]==null && $_GET[id]!="huir") {
    ...
    echo "<center><marquee style=\"width:500px\"> $cic[mess] </marquee></center>"; ?>
	 ...
	 <?php echo "<center><a href=\"ciudad/?id=agobierno&ciudad=$cic[nombre]\" Class=\"navlink\">Ayuntamiento</a></center>
		   </td>
	   </tr>";
    ...
    if ($cic[nombre]!=$ci[nombre]) {
        echo "<br><a href=\"viaje/?id=ok&ci=$cic[nombre]&pl=$plc[nombre]\">Viajar a la ciudad</a>";
    }
