...
if ($cli[nombre]!=""){	 
  if ($ok){
   ...
   if ($_GET[turnos]<=0){
	  ...
	  echo '<form action="ciudad/" method="GET">Gastar <input name="turnos" type="input" value="1">Energía. <input name="id" type="hidden" value="igenerador"><input name="ok" value="Trabajar" type="submit"></form>';
  }
