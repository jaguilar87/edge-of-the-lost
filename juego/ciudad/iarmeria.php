...
if ($ci[armeria]=="S" && $us[nombre]==$ci[rey]){
   if ($_GET[ok]){
				  ...
				  if ($vl[nombre]=="" || $vl[arma]!="" || $vl[uso]=="S" && $vl[prop]=="$us[clan]"){
				  	 echo "Veh�culo destino inexistente, en uso o con un arma ya ensamblada";
				  }else{
   						 ...
   						 if ($cl[potencia]<0 || $cl[mineral]<0){
						 	echo "Pot�ncia o mineral insuficiente...";
						 }else{
...
<tr>
    <td><big><big><b>Armer�a de $ci[nombre]</b></big></big>";   
   		 echo "<br>Bienvenido a la armer�a <b>$us[nombre]</b>! En las armerias convertiremos su potencia y mineral en poderosos poderosas armas para los vehiculos de su clan, esperamos sus instrucciones.<br><br>"; 
...
<tr>
    <td>   <form action="ciudad/" method="GET"><input type="hidden" name="id" value="iarmeria" />
					   	   ...
					   	   Arma: 
								 ...
								 <br>&nbsp;&nbsp;<input name="tip" type="radio" value="ariete">Ariete T�rmico 
...
';
		 echo '<small><b><b>Armas:</b></b></small><br><small><table width="100%"><tr bgcolor="#808080"><td><small><b>Nombre</b></small></td><td><small><b>Tipo</b></small></td><td><small>Minerales</small></td><td><small>Potencia</small></td></tr><tr><td><small>Mortero Bl�ster</small></td><td><small>AntiPersona</small></td><td><small>100M</small></td><td><small>100W</small></td></tr><tr><td><small>Disruptor</small></td><td><small>AntiVehiculo AntiTorre</small></td><td><small>50M</small></td><td><small>150W</small></td></tr><tr><td><small>Ariete T�rmico</small></td><td><small>AntiEscudo</small></td><td><small>50M</small></td><td><small>150W</small></td></tr></table>
		 </small></td>
</tr>
</table>';
