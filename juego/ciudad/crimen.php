...
<tr><td><input name="tr" type="radio" value="maquina"> Romper m�quina</td><td><i>Sacar dinero de m�quinas expendedoras (Vigor)</i></td></tr>
<tr><td><input name="tr" type="radio" value="bolsillo"> Vaciar Bolsillos</td><td><i>Vaciar bolsillos de transeuntes (Destreza)</i></td></tr>
<tr><td><input name="tr" type="radio" value="amenazar"> Amenazar</td><td><i>Amenazar transeuntes (Constituci�n)</i></td></tr>
<?php } 
...
if ($ci[burdel]=="S"){echo '<br>- La ciudad dispone de un <a href="ciudad/?id=rburdel">Burdel</a>';}
}
