...
echo '<big><big><b>Ranking y Estad�stica del Juego</b></big></big>';
...
<tr>
		<td>
			Versi�n del juego: <b>$ver[val]</b><br>
			Partida: <b>$par[val]</b><br>
			D�as de juego: <b>$fe[val]</b><br><br>
...
<tr>
	   ...
	   echo '<table width="100%" cellpading="5" cellspacing="5" bgcolor="#4f4f4f" ><caption align="TOP"><b>Los m�s ricos</b></caption><tr><td><b>Nombre</b></td><td><b>Cr�ditos</b></td></tr>';
	   ...
	   $result=mysql_query($c)or die(mysql_error());
	   $i=1;
	   while ($r = mysql_fetch_array($result)){echo "<tr><td><b>$i.</b> $r[nombre]</td><td>XXX</td></tr>"; $i++;}
	   echo '</table>';
...
<tr>
	   ...
	   echo '<table width="100%" cellpading="5" cellspacing="5" bgcolor="#4f4f4f" ><caption align="TOP"><b>Los Mejores Luchadores</b></caption><tr><td><b>Nombre</b></td><td><b>M�rito</b></td></tr>';
	   ...
	   echo '<table width="100%" cellpading="5" cellspacing="5" bgcolor="#4f4f4f"><caption align="TOP"><b>M�s Victorias</b></caption><tr><td><b>Nombre</b></td><td><b>PK G</b></td><td><b>PK P</b></td></tr>';
