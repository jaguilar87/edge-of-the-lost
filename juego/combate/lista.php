<?php
	...
	if ($_GET[at]==""){
		...
		echo "Mostrando los �ltimos 20 Ataques:<br>";
		...
		if ($us[clan]!=""){
			...
			echo "<a name=\"clan\"></a><br><hr><br>Mostrando los �ltimos 20 Ataques a ciudades de tu clan:<br>";
...
echo "<br><br><var>RECUERDA: La descripci�nes de los combates con m�s de 7 dias ser�n borradas.</var>";
