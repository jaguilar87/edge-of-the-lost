<?php
	...
	$sql = "INSERT INTO `sw_att` (dia, atacante, defensor, combate, ganador, ganancias) VALUES ('$us[dia]', '$us[nombre]', '$ob[nombre]', 'Se ha prescindido del combate por motivos de Tama�o.', '$ganador', '$ganancias')";
