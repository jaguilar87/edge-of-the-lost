...
<?php include 'juego/header/genstyle.php'; ?>
</head>
...
<table summary="" bgcolor="#000000">
			 ...
			 <tr>
			 		 <td width=500>
					 	 								 		 La siguiente es una lista de reconocimiento a todos aquellos que han contribuido con la creación de este juego.<br />
