...
class Smtp
{
	var $user="urbin+jag-team.com";
	var $realm="urbin@jag-team.com";
	var $password="nova00";
	var $workstation="";
	...
	var $html_debug=0;
	var $esmtp=1;
	var $esmtp_host="localhost";
	var $esmtp_extensions=array();
	var $maximum_piped_recipients=100;
	var $exclude_address="";
	var $getmxrr="GetMXRR";
	var $pop3_auth_host="localhost";
	...
	function ConnectToHost($domain, $port, $resolveaddToMessage)
	{
		...
		{
			if ($this->debug)
				$this->OutputDebug($resolveaddToMessage);
